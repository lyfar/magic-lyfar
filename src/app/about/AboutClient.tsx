...
function AboutClient() {
  ...
  const handleServiceClick = (serviceTitle: string) => {
    ...
    } else if (serviceTitle === "Software") {
      filterTag = "Software&Design";
    } else if (serviceTitle === "Video & Content" || serviceTitle === "Content Production") {
